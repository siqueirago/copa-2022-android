...
// Criar o Work Manager para orquestrar as Noticicações Push Localmante
...
class NotificationMatcherWorker(
    ...
    override fun doWork(): Result {
        ...
        context.showNotification(title, content) // Passando título e conteúdo para o método
    ...
    companion object {
        fun start(context: Context, match: MatchDomain){
            ...
            val initialDelay = Duration.between(LocalDateTime.now(),matchDate).plusMinutes(5)
